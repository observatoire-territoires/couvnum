...
```{r calcul_opemieuxdisant_comm, echo=F, message=F, warning=F, include = F, eval=FALSE}
...
.pull-left[
```{r plot_opemieuxdisant_actuel_comm,eval=F, echo=F, message=F, warning=F, fig.width=8,fig.height=7.5, fig.retina=2}
...
```{r plot_opemieuxdisant_evol_comm,eval=F, echo=F, message=F, warning=F, fig.width=8,fig.height=7.5, fig.retina=2}
ggplot() +
