...
.pull-right[
<img src="./img/couv4G_nb_operateurs_072017_v4.png" width=600 >
]
...
.pull-right[
<img src="./img/couv4G_nb_operateurs_012019_v4.png" width=600>
]
...
```{r plot_nb_operateurs_s_reg_012019,echo=F, message=F, warning=F, fig.width=13,fig.height=8, fig.retina=5}
...
stats_croiz_superfice_nboperateurdetail <-
  ...
  rbind.data.frame(COMM_BDA16_4G_ORF_SFR_BYT_FRE_NA_012019 %>%
    ...
    mutate(nb_OPE_couv = case_when(couvs_OPE %in% '' ~ 0,
                                 ...
                                 couvs_OPE %in% c('ORF_BYT_NA_FRE','NA_BYT_SFR_FRE','ORF_BYT_SFR_NA','ORF_NA_SFR_FRE') ~ 3,
                                 couvs_OPE %in% c('ORF_BYT_SFR_FRE') ~ 4) ) %>%
  mutate(nb_detail_OPE_couv = case_when(couvs_OPE %in% '' ~ "Zone blanche", 
...
ggplot(stats_croiz_superfice_nboperateurdetail %>%
  ...
  geom_treemap_text( layout = "fixed", grow = F, reflow = T, colour = "black") +
  geom_treemap_subgroup_border(layout = "fixed", colour = "black", size =1) +
  scale_fill_manual(values = c('#000000',"#252525","#525252", "orangered","red","dodgerblue","green", "white"), name ="", guide=guide_legend(reverse=T)) +
  theme_ipsum_rc() +
  theme(axis.text.y = element_blank(),
        legend.text=element_text(size=15),
        strip.text.x = element_text(face = "bold"),
...
.pull-right[
<img src="./img/couv4G_nb_detail_operateurs_072017_v4.png" width=600 >
]
...
.pull-right[
<img src="./img/couv4G_nb_detail_operateurs_012019_v4.png" width=600 >
]
...
.pull-left[
```{r plot_opemieuxdisant_actuel_comm, echo=F, message=F, warning=F, fig.width=8,fig.height=8, fig.retina=2}
...
```{r plot_opemieuxdisant_evol_comm, echo=F, message=F, warning=F, fig.width=8,fig.height=8, fig.retina=2}
ggplot() +
...
```{r plot_reg,echo=F, message=F, warning=F}
...
x <- girafe(ggobj = ggi_slope_reg, height_svg = 5)
x <- girafe_options(x, 
...
widgetframe::frameWidget(x, width = "70%", height = 20)
...
<iframe width='1000' height='600' src='https://statistiques-locales.insee.fr/?view=map1&indics=bdcom.pt_log_rp&serie=2015&lang=fr&iframe=1'></iframe>
...
<img src="./img/ELIGFIXE_012019_tableauequipements_v2.png" height=550>
